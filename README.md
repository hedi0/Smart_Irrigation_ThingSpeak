...
This **Smart Irrigation System** is an IoT-based solution that automates plant watering based on real-time soil moisture readings. It monitors environmental conditions and uploads data to ThingSpeak cloud
